...
export class CarritoPage implements OnInit {
  ...
  async ionViewWillEnter() {
    ...
    this.id_cliente = localStorage.getItem('id_cliente');
    this.puntos = Number(localStorage.getItem('puntos'));



    // se guardan puntos a actualizar en bd
    localStorage.setItem('puntos_finales',String(this.puntos))

    console.log("dots",this.puntos);
    ...
    if (this.id_cliente == false || this.id_cliente == null) {
      ...
      await this.getProductosCarrito
        ...
        .then(async (respuesta) => {
          ...
          localStorage.setItem('totales_final_nuevo', this.totales)
  ...
  async menos(idmkt_carrito: any, cantidad: any, precio: any) {
    ...
    if (cantidad > 1) {
      ...
      let params = {
        data: [
          { cantidad: contador, total: total, idmkt_carrito: idmkt_carrito },
        ],
      };

      await this.updateCantidadCarrito
        .UpdateCantidadTotal(params)
        .then(async (resp) => {
          // console.log(resp);
  ...
  //     this.totales_descuento = Number((this.totales * 0.4).toFixed(2));
  ...
  //     this.totales_final = this.totales_final + this.c_envio - this.puntos;
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: async (alertData) => {
            ...
            await this.deleteProductoCarrito
              .DeleteProductoCarrito(params)
              .then(async (resp) => {
                // console.log(resp);
  ...
  resumen() {
    console.log(localStorage.getItem('totales_final_nuevo'));
  ...
  checkboxClick(e: any) {
    ...
    if (e.detail.checked == true) {
      ...
      this.puntosact = this.puntos;

    
      // localStorage.setItem('totales_final', this.suma2);

// menor
    //  <=0 ? this.totales=0: this.totales-this.puntosact

// mayor
console.log(this.totales)
console.log(this.puntosact)




      if( this.totales-this.puntosact<=0){

   this.puntossobrantes=(this.totales-this.puntosact)*-1



   // se guardan puntos a actualizar en bd
   localStorage.setItem('puntos_finales',String(this.puntossobrantes))
        ...
        //  console.log(this.puntossobrantes)
      }
      else{
        ...
        this.totales= this.totales-this.puntosact

     

this.puntossobrantes=0
localStorage.setItem('puntos_finales',String(this.puntossobrantes))
...
console.log(this.puntossobrantes)
      ...
      console.log('na');
  this.totales= Number(localStorage.getItem('totales_final'))
      console.log(this.totales)
      // this.totales>=500?this.c_envio=0:this.c_envio=80

      // this.puntossobrantes=this.puntosact
